# HADES Good / Bad / Ugly Audit

Generated: 2026-07-26T05:57:35.835171+00:00
Run ID: `system-audit-20260726T055735Z`
Contract: `arda.audit.target_report.v1`
Score: **100/100**

## Duties
- Lifecycle hygiene, no-delete organization review, and audit receipts.
...
- Observed 1698 audit/status/telemetry/logging token hits in scoped files.
...
- support path (`scripts/hades_organization_maintenance.sh`)
- support path (`data/hades`)
