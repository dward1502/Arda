...
pub const KNOWLEDGE_DELTA_SCHEMA_VERSION: &str = "annunimas.athena.knowledge_delta.v1";
...
pub fn emit_delta_to_file(
    ...
    if !delta.is_valid_contract_shape() {
        return Err(std::io::Error::new(
            ...
            "knowledge delta does not satisfy annunimas.athena.knowledge_delta.v1",
        ));
    }
