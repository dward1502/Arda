...
pub(super) struct BanditStore {
    ...
    pending_by_provider: Mutex<BTreeMap<String, VecDeque<String>>>,
}
...
fn bandit_score_weight() -> f64 {
    std::env::var("ANNUNIMAS_CHARON_BANDIT_SCORE_WEIGHT")
        .ok()
...
fn bandit_min_observations() -> u64 {
    std::env::var("ANNUNIMAS_CHARON_BANDIT_MIN_OBSERVATIONS")
        .ok()
