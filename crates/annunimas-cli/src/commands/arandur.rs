    ...
    match command {
        ArandurCommands::Status { root } => {
            ...
            let value = if state_path.exists() {
                ...
                json!({
                    "contract": "annunimas.arandur.runtime_state.v1",
                    "status": "missing",
...
pub(crate) fn resolve_root(root: Option<String>) -> PathBuf {
    root.map(PathBuf::from)
        .or_else(|| std::env::var("ANNUNIMAS_ROOT").ok().map(PathBuf::from))
        .unwrap_or_else(annunimas_root)
}
...
fn arandur_default_state() -> serde_json::Value {
    json!({
        ...
        "surfaces": {
            "status_cli": "annunimas-cli prometheus arandur status",
            "initialize_cli": "annunimas-cli prometheus arandur initialize",
            "episode_cli": "annunimas-cli prometheus arandur record-episode",
            "observe_cli": "annunimas-cli prometheus arandur observe",
            "review_packet_cli": "annunimas-cli prometheus arandur review-packet --packet-dir <path>",
            "recommend_next_cli": "annunimas-cli prometheus arandur recommend-next",
            "readiness_cli": "annunimas-cli prometheus arandur readiness",
            "athena_packet_intake_cli": "annunimas-cli athena packet-intake",
            "athena_packet_promotion_cli": "annunimas-cli athena packet-promotion-surface"
        },
        "promotion_gates": [
            "evidence_present",
...
fn append_arandur_episode(
    ...
    let value = json!({
        "contract": "annunimas.arandur.episode.v1",
        "authority": "agent_generated",
        "review_required": true,
...
fn observe_arandur(root: &Path) -> anyhow::Result<serde_json::Value> {
    ...
    Ok(json!({
        "contract": "annunimas.arandur.observation.v1",
        "authority": "agent_generated",
        "review_required": true,
        "generated_at_utc": Utc::now().to_rfc3339(),
...
fn report_arandur_mission_backlog(root: &Path) -> anyhow::Result<serde_json::Value> {
    ...
    Ok(json!({
        "contract": "annunimas.arandur.mission_backlog.v1",
        "authority": "agent_generated",
        "review_required": true,
        "generated_at_utc": Utc::now().to_rfc3339(),
...
fn report_arandur_gate_next(root: &Path) -> anyhow::Result<serde_json::Value> {
    ...
    Ok(json!({
        "contract": "annunimas.arandur.gate_next.v1",
        "authority": "agent_generated",
        "review_required": true,
        "generated_at_utc": Utc::now().to_rfc3339(),
        "status": status,
...
fn report_arandur_gate_blocked(root: &Path) -> anyhow::Result<serde_json::Value> {
    ...
    Ok(json!({
        "contract": "annunimas.arandur.gate_blocked.v1",
        "authority": "agent_generated",
        "review_required": true,
        "generated_at_utc": Utc::now().to_rfc3339(),
...
fn append_arandur_gate_decision(
    ...
    let contract = if decision == "approved" {
        "annunimas.arandur.gate_approval.v1"
    } else {
        "annunimas.arandur.gate_denial.v1"
    };
...
fn map_arandur_system(root: &Path) -> anyhow::Result<serde_json::Value> {
    ...
    let packet_gates_clean = packet_review
        ...
        .unwrap_or(false);
    let triad_path = root.join("crates/annunimas-governance/src/triad.rs");
    let resonance_path = root.join("crates/annunimas-governance/src/resonance.rs");
    let plutus_path = root.join("crates/annunimas-plutus/src/lib.rs");
    ...
    Ok(json!({
        "contract": "annunimas.arandur.system_map.v1",
        "authority": "agent_generated",
        "review_required": true,
        "generated_at_utc": Utc::now().to_rfc3339(),
        ...
        "prometheus": {
            ...
            "autopilot_module_present": root.join("crates/annunimas-prometheus/src/autopilot/mod.rs").exists(),
            "cli_anchor_present": root.join("crates/annunimas-cli/src/commands/arandur.rs").exists()
        },
        "athena": {
...
pub(crate) fn scan_arandur_improvements(root: &Path) -> anyhow::Result<serde_json::Value> {
    ...
    let blocked_by_review_gate = !readiness["readiness_gate_stack_clean"]
        ...
        .unwrap_or(false);
    Ok(json!({
        "contract": "annunimas.arandur.improvement_scan.v1",
        "authority": "agent_generated",
        "review_required": true,
        "generated_at_utc": Utc::now().to_rfc3339(),
...
fn plan_arandur_phase6b_scout(
    ...
    Ok(json!({
        "contract": "annunimas.arandur.phase6b_scout_plan.v1",
        "authority": "agent_generated",
        "review_required": true,
        "generated_at_utc": Utc::now().to_rfc3339(),
        "phase": "6B",
...
fn build_phase6b_scout_mission(
    ...
    json!({
        ...
        "completion_gate": {
            ...
            "json_contract_required": "annunimas.arandur.phase6b_scout_plan.v1"
        }
    })
}
...
fn execute_arandur_phase6c_scout(
    ...
    let now = Utc::now();
    let candidate = json!({
        "contract": "annunimas.arandur.phase6c_scout_finding.v1",
    ...
    Ok(json!({
        "contract": "annunimas.arandur.phase6c_scout_execution.v1",
        "authority": "agent_generated",
        "review_required": true,
        "phase": "6C",
        "status": status,
...
fn synthesize_arandur_phase6d_patterns(
    ...
    let now = Utc::now();
    let record = json!({
        "contract": "annunimas.arandur.phase6d_pattern_synthesis_record.v1",
        "authority": "agent_generated",
        "review_required": true,
        "phase": "6D",
    ...
    Ok(json!({
        "contract": "annunimas.arandur.phase6d_pattern_synthesis.v1",
        "authority": "agent_generated",
        "review_required": true,
        "phase": "6D",
        "status": status,
...
fn promote_arandur_phase6e_missions(
    ...
    Ok(json!({
        "contract": "annunimas.arandur.phase6e_mission_promotion.v1",
        "authority": "agent_generated",
        "review_required": true,
        "phase": "6E",
        "status": status,
        ...
        .filter(|record| agent_generated_review_gated_value(record))
    {
            ...
            .filter(|pattern| agent_generated_review_gated_value(pattern))
        {
            ...
            candidates.push(json!({
                "contract": "annunimas.arandur.phase6e_mission_candidate.v1",
...
fn review_arandur_phase6f_mission_candidates(
    ...
    Ok(json!({
        "contract": "annunimas.arandur.phase6f_mission_candidate_review.v1",
        "authority": "agent_generated",
        "review_required": true,
        "phase": "6F",
        "status": status,
...
fn build_phase6f_mission_review_packets(
    ...
    candidate_records
        ...
        .map(|candidate| {
            ...
            json!({
                "contract": "annunimas.arandur.phase6f_mission_review_packet.v1",
...
fn request_arandur_phase6g_mission_approval(
    ...
    Ok(json!({
        "contract": "annunimas.arandur.phase6g_mission_approval_request_surface.v1",
        "authority": "agent_generated",
        "review_required": true,
        "phase": "6G",
        "status": status,
...
fn build_phase6g_mission_approval_requests(
    ...
    review_records
        ...
        .map(|review| {
            ...
            json!({
                "contract": "annunimas.arandur.phase6g_mission_approval_request.v1",
...
fn record_arandur_phase6g_mission_approval_decision(
    ...
    let decision = json!({
        "contract": "annunimas.arandur.phase6g_mission_approval_decision.v1",
    ...
    Ok(json!({
        "contract": "annunimas.arandur.phase6g_mission_approval_decision_surface.v1",
        "authority": "operator_approved_agent_execution",
        "review_required": true,
        "phase": "6G",
...
fn propose_arandur_phase6h_mission_queue_entries(
    ...
    Ok(json!({
        "contract": "annunimas.arandur.phase6h_mission_queue_proposal_surface.v1",
        "authority": "agent_generated",
        "review_required": true,
        "phase": "6H",
        "status": status,
...
fn build_phase6h_mission_queue_proposals(
    ...
    approval_records
        ...
        .map(|approval| {
            ...
            json!({
                "contract": "annunimas.arandur.phase6h_mission_queue_proposal.v1",
...
fn request_arandur_phase6i_mission_queue_write(
    ...
    Ok(json!({
        "contract": "annunimas.arandur.phase6i_mission_queue_write_request_surface.v1",
        "authority": "agent_generated",
        "review_required": true,
        "phase": "6I",
        "status": status,
...
fn build_phase6i_mission_queue_write_requests(
    ...
    proposal_records
        ...
        .map(|proposal| {
            ...
            json!({
                "contract": "annunimas.arandur.phase6i_mission_queue_write_request.v1",
...
fn execute_arandur_phase6j_queue_write(
    ...
    Ok(json!({
        "contract": "annunimas.arandur.phase6j_canonical_queue_write_surface.v1",
        "authority": "operator_approved_agent_execution",
        "review_required": true,
        "phase": "6J",
        "status": status,
        ...
        "roadmap_anchor": {
            "parent_plan": "docs/plans/annunimas-autonomy-readiness-and-human-ingestion-plan.md",
...
fn append_arandur_presence_event(
    ...
    let record = json!({
        ...
        "metrics": {},
        "trace": {
            "source": "annunimas-cli.prometheus.arandur.presence-event",
    ...
    Ok(json!({
        "contract": "annunimas.arandur.presence_event_writer.v1",
...
fn run_arandur_cycle(
    ...
    Ok(json!({
        "contract": "annunimas.arandur.supervised_cycle.v1",
        "authority": "agent_generated",
        "review_required": true,
        "generated_at_utc": Utc::now().to_rfc3339(),
...
fn benchmark_arandur_safety(root: &Path, packet_dir: &Path) -> anyhow::Result<serde_json::Value> {
    ...
    Ok(json!({
        "contract": "annunimas.arandur.safety_benchmark.v1",
        "authority": "agent_generated",
        "review_required": true,
        "generated_at_utc": Utc::now().to_rfc3339(),
...
fn report_bounded_mutation_classes(root: &Path) -> anyhow::Result<serde_json::Value> {
    ...
    let current_level = runtime_state
        ...
        .unwrap_or(1);
    Ok(json!({
        "contract": "annunimas.arandur.bounded_mutation_classes.v1",
        "authority": "agent_generated",
        "review_required": true,
        "generated_at_utc": Utc::now().to_rfc3339(),
        "current_level": current_level,
...
fn verify_bounded_mutation(
    ...
    let verification_passed = target_matches_class
        ...
        && json_valid;
    let report = json!({
        "contract": "annunimas.arandur.bounded_mutation_verification.v1",
        "authority": "agent_generated",
        "review_required": true,
...
fn report_bounded_rollback_evidence(
    ...
    let report = json!({
        "contract": "annunimas.arandur.rollback_evidence.v1",
        "authority": "agent_generated",
        "review_required": true,
...
fn review_arandur_packet(root: &Path, packet_dir: &Path) -> anyhow::Result<serde_json::Value> {
    ...
    Ok(json!({
        "contract": "annunimas.arandur.packet_review.v1",
        "authority": "agent_generated",
        "review_required": true,
        "generated_at_utc": Utc::now().to_rfc3339(),
        "packet_dir": display_path(packet_dir),
...
fn recommend_arandur_next_from_packet(
    ...
    Ok(json!({
        "contract": "annunimas.arandur.recommendation_batch.v1",
        "authority": "agent_generated",
        "review_required": true,
...
fn build_recommendation_record(
    ...
    json!({
        "contract": "annunimas.arandur.recommendation.v1",
        "authority": "agent_generated",
        "review_required": true,
...
pub(crate) fn summarize_arandur_recommendations(root: &Path) -> anyhow::Result<serde_json::Value> {
    ...
    Ok(json!({
        "contract": "annunimas.arandur.recommendation_ledger_summary.v1",
        "authority": "agent_generated",
        "review_required": true,
        "generated_at_utc": Utc::now().to_rfc3339(),
        "ledger_path": ARANDUR_RECOMMENDATIONS_PATH,
...
fn assess_arandur_readiness(root: &Path) -> anyhow::Result<serde_json::Value> {
    ...
    Ok(json!({
        "contract": "annunimas.arandur.readiness.v1",
        "authority": "agent_generated",
        "review_required": true,
        "generated_at_utc": Utc::now().to_rfc3339(),
        "current_level": current_level,
...
fn promote_arandur_level(
    ...
    if write && already_at_target {
        return Ok(json!({
            "contract": "annunimas.arandur.level_promotion.v1",
            "authority": "agent_generated",
            "review_required": true,
            "generated_at_utc": Utc::now().to_rfc3339(),
...
mod tests {
    ...
    fn temp_root(name: &str) -> anyhow::Result<PathBuf> {
        ...
        let root = std::env::temp_dir().join(format!("annunimas_arandur_{name}_{nanos}"));
    ...
    fn observe_reports_state_without_mutating_queue() -> anyhow::Result<()> {
        ...
        assert_eq!(observed["contract"], "annunimas.arandur.observation.v1");
    ...
    fn mission_backlog_reports_no_open_tasks_when_raw_pending_records_are_superseded(
        ...
        assert_eq!(report["contract"], "annunimas.arandur.mission_backlog.v1");
    ...
    fn review_packet_detects_existing_queue_ids_and_review_gates() -> anyhow::Result<()> {
        ...
        assert_eq!(review["contract"], "annunimas.arandur.packet_review.v1");
    ...
    fn cycle_dry_run_does_not_mutate_ledgers_or_queue() -> anyhow::Result<()> {
        ...
        assert_eq!(cycle["contract"], "annunimas.arandur.supervised_cycle.v1");
    ...
    fn presence_event_writer_is_bounded_append_only_and_idempotent() -> anyhow::Result<()> {
        ...
        assert_eq!(records[0]["schema"], "annunimas.arda.presence_event.v1");
    ...
    fn benchmark_reports_read_only_safety_without_mutating_ledgers_or_queue() -> anyhow::Result<()>
    {
        ...
        assert_eq!(
            benchmark["contract"],
            "annunimas.arandur.safety_benchmark.v1"
        );
    ...
    fn recommendation_summary_detects_duplicate_ids_and_review_gates() -> anyhow::Result<()> {
        ...
        assert_eq!(
            summary["contract"],
            "annunimas.arandur.recommendation_ledger_summary.v1"
        );
    ...
    fn readiness_requires_clean_level_two_gates() -> anyhow::Result<()> {
        ...
        assert_eq!(readiness["contract"], "annunimas.arandur.readiness.v1");
    ...
    fn readiness_surfaces_effective_mission_backlog_for_next_gate_selection() -> anyhow::Result<()>
    {
        ...
        assert_eq!(
            ...
            "annunimas.arandur.mission_backlog.v1"
        );
    ...
    fn system_map_reports_governance_crate_layers_and_athena_surfaces() -> anyhow::Result<()> {
        ...
        write(
            &root,
            "crates/annunimas-governance/src/triad.rs",
            "pub struct Triad;\n",
        )?;
        write(
            &root,
            "crates/annunimas-governance/src/resonance.rs",
            "pub fn calculate_resonance_basic() {}\n",
        )?;
        write(
            &root,
            "crates/annunimas-plutus/src/lib.rs",
        ...
        assert_eq!(map["contract"], "annunimas.arandur.system_map.v1");
    ...
    fn improvement_scan_emits_review_gated_governance_candidates_without_mutation(
        ...
        assert_eq!(scan["contract"], "annunimas.arandur.improvement_scan.v1");
    ...
    fn promote_level_dry_run_reports_approval_without_mutating_runtime() -> anyhow::Result<()> {
        ...
        assert_eq!(
            promotion["contract"],
            "annunimas.arandur.level_promotion.v1"
        );
    ...
    fn bounded_mutation_classes_report_level_two_contract() -> anyhow::Result<()> {
        ...
        assert_eq!(
            report["contract"],
            "annunimas.arandur.bounded_mutation_classes.v1"
        );
    ...
    fn verify_mutation_reports_pre_post_evidence_without_default_append() -> anyhow::Result<()> {
        ...
        assert_eq!(
            report["contract"],
            "annunimas.arandur.bounded_mutation_verification.v1"
        );
    ...
    fn rollback_report_appends_review_gated_evidence_when_requested() -> anyhow::Result<()> {
        ...
        assert_eq!(report["contract"], "annunimas.arandur.rollback_evidence.v1");
    ...
    fn phase6b_scout_plan_is_review_gated_and_read_only() -> anyhow::Result<()> {
        ...
        assert_eq!(plan["contract"], "annunimas.arandur.phase6b_scout_plan.v1");
    ...
    fn phase6c_scout_execute_is_dry_run_and_review_gated_by_default() -> anyhow::Result<()> {
        ...
        assert_eq!(
            report["contract"],
            "annunimas.arandur.phase6c_scout_execution.v1"
        );
    ...
    fn phase6d_pattern_synthesis_aggregates_ledgers_without_default_mutation() -> anyhow::Result<()>
    {
        ...
        assert_eq!(
            synthesis["contract"],
            "annunimas.arandur.phase6d_pattern_synthesis.v1"
        );
    ...
    fn phase6e_mission_promotion_is_dry_run_and_review_gated_by_default() -> anyhow::Result<()> {
        ...
        assert_eq!(
            report["contract"],
            "annunimas.arandur.phase6e_mission_promotion.v1"
        );
    ...
    fn phase6f_mission_candidate_review_is_dry_run_and_review_gated_by_default(
        ...
        assert_eq!(
            report["contract"],
            "annunimas.arandur.phase6f_mission_candidate_review.v1"
        );
    ...
    fn phase6g_mission_approval_request_is_dry_run_and_review_gated_by_default(
        ...
        assert_eq!(
            report["contract"],
            "annunimas.arandur.phase6g_mission_approval_request_surface.v1"
        );
    ...
    fn phase6h_mission_queue_proposal_is_dry_run_and_review_gated_by_default() -> anyhow::Result<()>
    {
        ...
        assert_eq!(
            report["contract"],
            "annunimas.arandur.phase6h_mission_queue_proposal_surface.v1"
        );
    ...
    fn phase6i_mission_queue_write_request_is_dry_run_and_review_gated_by_default(
        ...
        assert_eq!(
            report["contract"],
            "annunimas.arandur.phase6i_mission_queue_write_request_surface.v1"
        );
    ...
    fn phase6j_queue_write_is_dry_run_and_requires_approved_requests() -> anyhow::Result<()> {
        ...
        assert_eq!(
            report["contract"],
            "annunimas.arandur.phase6j_canonical_queue_write_surface.v1"
        );
    ...
    fn gate_next_selects_review_gated_recommendation_without_queue_mutation() -> anyhow::Result<()>
    {
        ...
        assert_eq!(report["contract"], "annunimas.arandur.gate_next.v1");
    ...
    fn gate_blocked_groups_candidates_by_reason_and_class() -> anyhow::Result<()> {
        ...
        assert_eq!(report["contract"], "annunimas.arandur.gate_blocked.v1");
        assert_eq!(
    ...
    fn gate_approve_appends_status_approved_packet_and_is_idempotent() -> anyhow::Result<()> {
        ...
        assert_eq!(first["contract"], "annunimas.arandur.gate_approval.v1");
    ...
    fn gate_deny_appends_blocking_decision_without_approving_candidate() -> anyhow::Result<()> {
        ...
        assert_eq!(report["contract"], "annunimas.arandur.gate_denial.v1");
