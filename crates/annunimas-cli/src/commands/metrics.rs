// sigil: SCROLL
//
// Prometheus exposition exporter for the Annunimas fleet.
//
...
use super::super::{annunimas_root, MetricsCommands};
...
pub(crate) async fn handle(command: MetricsCommands) -> Result<()> {
    match command {
        MetricsCommands::Serve {
            ...
            info!(%addr, refresh_secs, "annunimas metrics exporter listening");
