...
pub(crate) fn export_athena_integration_plan_impl() -> Result<Value> {
    ...
    let payload = json!({
        "schema_version": "annunimas.athena-integration-plan.v1",
        ...
        "integration_lanes": [
            {
                ...
                "write_through": [
                    ...
                    "crates/annunimas-cli/src/main.rs",
...
pub(crate) fn export_async_user_intake_contract_impl() -> Result<Value> {
    ...
    let payload = json!({
        "schema_version": "annunimas.async-user-intake-contract.v1",
        "generated_at_utc": now_utc(),
...
pub(crate) fn export_athena_digest_pipeline_impl() -> Result<Value> {
    ...
    let payload = json!({
        "schema_version": "annunimas.athena-digest-pipeline.v1",
        "generated_at_utc": now_utc(),
...
pub(crate) fn export_autonomy_resume_impl() -> Result<Value> {
    ...
    let payload = json!({
        "schema_version": "annunimas.autonomy-resume.v1",
        "generated_at_utc": now_utc(),
...
pub(crate) fn export_human_corpus_digest_plan_impl() -> Result<Value> {
    ...
    let payload = json!({
        "schema_version": "annunimas.human-corpus-digest-plan.v1",
        "generated_at_utc": now_utc(),
...
pub(crate) fn export_human_corpus_registry_impl() -> Result<Value> {
    ...
    let payload = json!({
        "schema_version": "annunimas.human-corpus-registry.v1",
        "generated_at_utc": now_utc(),
...
pub(crate) fn export_intake_confidence_ladder_impl() -> Result<Value> {
    ...
    let payload = json!({
        "schema_version": "annunimas.intake-confidence-ladder.v1",
        "generated_at_utc": now_utc(),
...
pub(crate) fn export_human_corpus_extraction_registry_impl() -> Result<Value> {
        ...
        .flatten()
    {
        ...
        let payload = json!({
            "schema_version": "annunimas.human-corpus-group.v1",
            "generated_at_utc": now_utc(),
    ...
    let registry = json!({
        "schema_version": "annunimas.human-corpus-extraction-registry.v1",
        "generated_at_utc": now_utc(),
        "authority": "bounded_human_corpus_group_extraction",
        "summary": {
...
pub(crate) fn export_source_absorption_executor_impl() -> Result<Value> {
    ...
    let payload = json!({
        "schema_version": "annunimas.source-absorption-executor.v1",
        "generated_at_utc": now_utc(),
...
pub(crate) fn export_source_absorption_pipeline_impl() -> Result<Value> {
    ...
    let payload = json!({
        "schema_version": "annunimas.source-absorption-pipeline.v1",
        "generated_at_utc": now_utc(),
...
pub(crate) fn export_source_absorption_portfolio_impl() -> Result<Value> {
    ...
    let payload = json!({
        "schema_version": "annunimas.source-absorption-portfolio.v1",
        "generated_at_utc": now_utc(),
...
pub(crate) fn export_source_ecosystem_registry_impl() -> Result<Value> {
    ...
    let payload = json!({
        "schema_version": "annunimas.source-ecosystem-registry.v1",
        "generated_at_utc": now_utc(),
...
pub(crate) fn export_community_signal_intake_impl() -> Result<Value> {
    ...
    let payload = json!({
        "schema_version": "annunimas.community-signal-intake.v1",
        "generated_at_utc": now_utc(),
...
pub(crate) fn export_research_workflow_contract_impl() -> Result<Value> {
    ...
    let payload = json!({
        "schema_version": "annunimas.research-workflow-contract.v1",
        "generated_at_utc": now_utc(),
...
pub(crate) fn export_apollo_research_workflow_runtime_impl() -> Result<Value> {
    ...
    let payload = json!({
        "schema_version": "annunimas.apollo-research-workflow-runtime.v1",
        "generated_at_utc": now_utc(),
        ...
        "workflow_engine_contract": {
            "workflow_struct_source": "crates/annunimas-apollo/src/workflow.rs",
            "execution_request_struct_source": "crates/annunimas-apollo/src/executor.rs",
...
pub(crate) fn export_hermes_community_sources_impl() -> Result<Value> {
    ...
    let payload = json!({
        "schema_version": "annunimas.hermes-community-sources.v1",
        "generated_at_utc": now_utc(),
...
pub(crate) fn export_multi_domain_routing_contract_impl() -> Result<Value> {
    ...
    let payload = json!({
        "schema_version": "annunimas.multi-domain-routing-contract.v1",
        "generated_at_utc": now_utc(),
...
pub(crate) fn export_socratic_validator_contract_impl() -> Result<Value> {
    ...
    let contract = json!({
        "schema_version": "annunimas.socratic-validator-contract.v1",
        "generated_at_utc": now_utc(),
    ...
    let audit = json!({
        "schema_version": "annunimas.socratic-validator-audit.v1",
        "generated_at_utc": now_utc(),
        "authority": "prometheus_oracle_deliberation_projection",
        "summary": {
            "invocations_total": 0,
...
pub(crate) fn export_agent_continuity_contract_impl() -> Result<Value> {
    ...
    let payload = json!({
        "schema_version": "annunimas.agent-continuity-contract.v1",
        "generated_at_utc": now_utc(),
        ...
        "mission": {
            ...
            "positioning": "Annunimas continuity belongs to sovereign state and governed workflows, not a foreign monolithic agent runtime.",
        },
...
fn human_contract_shape(group_id: &str) -> Value {
    match group_id {
        "numenor_architecture_contracts" => json!({
            ...
            "crate_candidates": ["annunimas-tool-harness", "annunimas-service-registry"],
        ...
        "between_two_fates" => json!({
            ...
            "crate_candidates": ["annunimas-storyworld"],
        ...
        "council_engine" => json!({
            ...
            "crate_candidates": ["annunimas-council"],
        ...
        "atelier" => json!({
            ...
            "crate_candidates": ["annunimas-atelier"],
        ...
        "forge_mind" => json!({
            ...
            "crate_candidates": ["annunimas-forge-mind"],
        ...
        "resonance" => json!({
            ...
            "crate_candidates": ["annunimas-resonance"],
        ...
        "scriptorium" => json!({
            ...
            "crate_candidates": ["annunimas-scriptorium"],
        ...
        "signal_engine" => json!({
            ...
            "crate_candidates": ["annunimas-signal-engine"],
        ...
        "signal_grid" => json!({
            ...
            "crate_candidates": ["annunimas-signal-grid"],
