...
pub(crate) fn export_source_ecosystem_operationalization_impl() -> Result<Value> {
    ...
    let payload = json!({
        "schema_version": "annunimas.source-ecosystem-operationalization.v1",
...
pub(crate) fn export_hermes_discord_runtime_impl() -> Result<Value> {
    ...
    let payload = json!({
        "schema_version": "annunimas.hermes-discord-runtime.v1",
        "generated_at_utc": now_utc(),
...
pub(crate) fn export_external_absorption_brief_impl() -> Result<Value> {
    ...
    let payload = json!({
        "schema_version": "annunimas.external-absorption-brief.v1",
        "generated_at_utc": now_utc(),
        "authority": "athena_books + sovereign_system_state",
        "mission": {
            "goal": "Convert externally observed systems into adopt/ignore/productize decisions for Annunimas without diluting sovereignty.",
        ...
        "adopt_now": [
            {
                ...
                "decision": "adapt",
                "reason": "Hermes Agent validates cross-session memory, skill self-improvement, and user-model continuity, which fit Annunimas biosystem goals.",
                "target_surfaces": [
        ...
        "ignore_or_defer": [
            {
                ...
                "decision": "defer",
                "reason": "Mission Control is useful as packaging signal, but Annunimas should not fork into another full TypeScript control plane.",
                "what_to_keep": [
                    "panel legibility",
        ...
        "productize_next": [
            {
                ...
                "goal": "Expose persistent memory, skill evolution, and session continuity as a first-class Annunimas operator capability.",
            },
            {
        ...
        "executive_verdict": {
            "annunimas_is_deeper_than_the_compared_projects": true,
            "annunimas_is_less_legible_as_a_product": true,
...
pub(crate) fn export_priority_human_contracts_impl() -> Result<Value> {
    ...
    let contracts = vec![
        (
            ...
            json!({
                "schema_version": "annunimas.tool-harness-architecture-contract.v1",
        ...
        (
            ...
            json!({
                "schema_version": "annunimas.business-intelligence-suite-contract.v1",
                "generated_at_utc": generated,
                ...
                "crate_candidate": "annunimas-council",
            }),
        ),
        (
            "engineering_suite_contract.json",
            json!({
                "schema_version": "annunimas.engineering-suite-contract.v1",
                "generated_at_utc": generated,
                ...
                "crate_candidate": "annunimas-forge-mind",
            }),
        ),
        (
            "social_pipeline_contract.json",
            json!({
                "schema_version": "annunimas.social-pipeline-contract.v1",
                "generated_at_utc": generated,
                ...
                "crate_candidate": "annunimas-signal-grid",
            }),
        ),
    ];
...
pub(crate) fn export_priority_human_crate_spawn_registry_impl() -> Result<Value> {
    ...
    let payload = json!({
        "schema_version": "annunimas.priority-human-crate-spawn-registry.v1",
        "generated_at_utc": now_utc(),
...
pub(crate) fn export_crawl4ai_runtime_contract_impl() -> Result<Value> {
    ...
    let payload = json!({
        "schema_version": "annunimas.crawl4ai-runtime-contract.v1",
        "generated_at_utc": now_utc(),
        ...
        "runtime_contract": {
            ...
            "runtime_env": ["ANNUNIMAS_CRAWL4AI_URL"],
            "health_requirements": [
...
pub(crate) fn export_litellm_routing_contract_impl() -> Result<Value> {
    ...
    let payload = json!({
        "schema_version": "annunimas.litellm-routing-contract.v1",
        "generated_at_utc": now_utc(),
...
pub(crate) fn export_llmfit_routing_contract_impl() -> Result<Value> {
    ...
    let payload = json!({
        "schema_version": "annunimas.llmfit-routing-contract.v1",
        "generated_at_utc": now_utc(),
        "authority": "package_enablement + package_runtime_activation + charon_router + runtime_governor_contract",
        "tool": {
            "name": "llmfit",
