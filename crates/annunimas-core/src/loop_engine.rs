...
//!
//! Per docs/plans/PHASE_1_PLAN.md: lives in annunimas-core for v0.1
...
impl ActionGate {
    fn to_json(&self) -> serde_json::Value {
        json!({
            "contract": "annunimas.action_classification.v1",
...
fn append_action_gate_receipt(
    ...
    let receipt = json!({
        "schema_version": "annunimas.action_gate_receipt.v1",
        "generated_at_utc": Utc::now().to_rfc3339(),
        "decision_id": decision_id,
        "task_id": task.id.to_string(),
        "task_type": task.task_type,
        "action_gate": gate.to_json(),
        "source": "annunimas-core.dispatch_full",
...
"#;
    ...
    fn dispatch_records_action_gate_receipt_for_safe_action() {
        ...
        assert!(content.contains("\"schema_version\":\"annunimas.action_gate_receipt.v1\""));
