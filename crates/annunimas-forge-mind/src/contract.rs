...
pub struct AnnunimasForgeMindContract {
...
pub fn contract() -> AnnunimasForgeMindContract {
    AnnunimasForgeMindContract {
        crate_name: "annunimas-forge-mind",
        realm: "operations",
        productizable: true,
        role: ForgeMindRole::BlueprintWorkflow,
        state_export_path: "core/state/annunimas-forge-mind.json",
