...
//!
//! Default endpoint: `http://annunimas-server:8188` (the backbone) — override
...
pub const DEFAULT_ADDR: &str = "http://annunimas-server:8188";
pub const DEFAULT_POLL_INTERVAL_SECS: u64 = 5;
pub const DEFAULT_TIMEOUT_SECS: u64 = 1800;
pub const DEFAULT_CLIENT_ID: &str = "annunimas-forge-mind";
