...
pub struct AnnunimasToolHarnessContract {
...
pub fn contract() -> AnnunimasToolHarnessContract {
    AnnunimasToolHarnessContract {
        crate_name: "annunimas-tool-harness",
        realm: "operations",
        productizable: true,
        role: ToolHarnessRole::BlueprintContract,
        state_export_path: "core/state/annunimas-tool-harness.json",
