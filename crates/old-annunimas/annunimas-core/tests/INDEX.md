...
# Index: crates/governance/annunimas-core/tests/INDEX.md
...
Crate index for `crates/governance/annunimas-core/tests/INDEX.md`. See sibling `INDEX.md` for bucket metadata.
