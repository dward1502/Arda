...
This crate may produce onboarding evidence and staged private configuration payloads, but mutation of operator configuration requires the explicit human-gate approval receipt path exposed through `annunimas-cli onboarding apply-config`.
