...
use annunimas_apollo::transport::ipc::send_command;
use annunimas_apollo::{ApolloExecutor, ExecutionPriority, ExecutionRequest, ExecutionStatus};
use serde::Serialize;
...
mod tests {
    ...
    async fn dispatches_apollo_task_via_daemon() {
        use annunimas_apollo::transport::ipc::run_ipc_server;
        use annunimas_apollo::ApolloService;
