...
# Index: crates/executors/arda-service-registry/src/INDEX.md
...
Crate index for `crates/executors/arda-service-registry/src/INDEX.md`. See sibling `INDEX.md` for bucket metadata.
