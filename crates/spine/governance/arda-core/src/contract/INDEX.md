...
# Index: crates/governance/arda-core/src/contract/INDEX.md
...
Crate index for `crates/governance/arda-core/src/contract/INDEX.md`. See sibling `INDEX.md` for bucket metadata.
