...
//! use arda_council::contract::ArdaCouncilContract;
//! use arda_council::{council::{CouncilQuery, CouncilSeat, QueryMode}, service};
//!
//! // Get the canonical contract
//! let c: ArdaCouncilContract = contract();
//! assert_eq!(c.crate_name, "arda-council");
...
///
/// ```
/// use arda_council::crate_identity;
///
/// assert_eq!(crate_identity(), "arda-council");
/// ```
