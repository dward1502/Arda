...
# Index: crates/interface/annunimas-apollo/src/INDEX.md
...
Crate index for `crates/interface/annunimas-apollo/src/INDEX.md`. See sibling `INDEX.md` for bucket metadata.
