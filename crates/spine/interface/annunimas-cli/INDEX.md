...
# Index: crates/interface/annunimas-cli/INDEX.md
...
- `README.md`
- `data`
- `hermes-verify-rgPl4z`
- `src`
- `tests`

## Purpose

Crate index for `crates/interface/annunimas-cli/INDEX.md`. See sibling `INDEX.md` for bucket metadata.
