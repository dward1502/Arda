use annunimas_hermes::{DecisionOption, HermesService, OutboundMessage};
use std::fs;
...
pub(crate) fn format_decision_prompt_message(prompt: &annunimas_hermes::DecisionPrompt) -> String {
    let mut lines = vec![
