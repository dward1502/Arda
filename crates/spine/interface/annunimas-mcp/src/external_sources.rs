...
pub fn notebooklm_connector_contract() -> ExternalSourceMcpConnector {
    ...
    ExternalSourceMcpConnector {
        schema_version: "annunimas.mcp.external_source_connector.v1".to_string(),
        ...
        athena_lane: AthenaLanePolicy {
            schema_version: "annunimas.athena.external_source_lane.v1".to_string(),
...
pub fn external_source_connector_tool() -> McpTool {
    McpTool::new(
        ...
        "Return Annunimas-governed MCP connector contracts for ATHENA external-source intake.",
    )
    .with_schema(json!({
        "type": "object",
        "properties": {
...
pub fn connector_catalog_response(source_id: Option<&str>) -> serde_json::Value {
    ...
    json!({
        "schema_version": "annunimas.mcp.external_source_catalog.v1",
        "task_promotion_allowed": false,
