...
# Index: crates/interface/annunimas-onboarding/INDEX.md
...
Crate index for `crates/interface/annunimas-onboarding/INDEX.md`. See sibling `INDEX.md` for bucket metadata.
