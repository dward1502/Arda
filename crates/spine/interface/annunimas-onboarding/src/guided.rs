...
use crate::constants::{ONBOARDING_GUIDED_SESSION_CONTRACT, ONBOARDING_OPERATOR_ANSWERS_CONTRACT};
use crate::device::device_scan;
use crate::helpers::now_utc;
use crate::prerequisites::build_prerequisite_report;
use crate::private_config::build_operator_answers_template;
    ...
    let mut steps = vec![
        ...
        guided_step(
            ...
            vec![
                ...
                "mutating actions require annunimas.onboarding.human_gate.v1".to_string(),
            ],
