...
pub(crate) fn export_remote_operator_contract_impl() -> Result<Value> {
    ...
    let payload = json!({
        "schema_version": "annunimas.remote-operator-contract.v1",
        ...
        "arda_hud_implications": {
            "long_term_model": "run_hud_on_any_operator_node_observe_state_from_annunimas_and_dispatch_work_to_system_nodes",
...
pub(crate) fn export_tool_garage_contract_impl() -> Result<Value> {
    ...
    let payload = json!({
        "schema_version": "annunimas.tool-garage-contract.v1",
        "generated_at_utc": now_utc(),
...
pub(crate) fn export_communication_adapter_contract_impl() -> Result<Value> {
    ...
    let payload = json!({
        "schema_version": "annunimas.communication-adapter-contract.v1",
        "generated_at_utc": now_utc(),
...
pub(crate) fn export_opencode_productization_contract_impl() -> Result<Value> {
    ...
    let payload = json!({
        "schema_version": "annunimas.opencode-productization-contract.v1",
        "generated_at_utc": now_utc(),
...
pub(crate) fn export_playwright_mcp_productization_contract_impl() -> Result<Value> {
    ...
    let payload = json!({
        "schema_version": "annunimas.playwright-mcp-productization-contract.v1",
        "generated_at_utc": now_utc(),
        ...
        "bridge_contract": {
            "crate_surface": "crates/annunimas-mcp/src/browser.rs",
...
pub(crate) fn export_nanoclaw_productization_contract_impl() -> Result<Value> {
    ...
    let payload = json!({
        "schema_version": "annunimas.nanoclaw-productization-contract.v1",
        "generated_at_utc": now_utc(),
