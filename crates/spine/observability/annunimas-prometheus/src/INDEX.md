...
# Index: crates/observability/annunimas-prometheus/src/INDEX.md
...
Crate index for `crates/observability/annunimas-prometheus/src/INDEX.md`. See sibling `INDEX.md` for bucket metadata.
