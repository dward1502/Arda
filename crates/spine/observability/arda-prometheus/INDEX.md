...
# Index: crates/observability/annunimas-prometheus/INDEX.md
...
Crate index for `crates/observability/annunimas-prometheus/INDEX.md`. See sibling `INDEX.md` for bucket metadata.
