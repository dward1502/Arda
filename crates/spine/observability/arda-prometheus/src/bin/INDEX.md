...
# Index: crates/observability/arda-prometheus/src/bin/INDEX.md
...
Crate index for `crates/observability/arda-prometheus/src/bin/INDEX.md`. See sibling `INDEX.md` for bucket metadata.
