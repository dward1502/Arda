...
const HUMAN_INGESTION_CONTRACT: &str = "annunimas.human_ingestion_result.v1";
const HADES_REVIEW_CONTRACT: &str = "annunimas.hades.human_lifecycle_review.v1";
...
impl HadesService {
    pub fn import_human_lifecycle_reviews(
        ...
        let report = HumanLifecycleImportReport {
            contract: "annunimas.hades.human_lifecycle_import_report.v1".to_owned(),
