...
const ORGANIZATION_AUDIT_CONTRACT: &str = "arda.hades.organization_audit_report.v1";
const ORGANIZATION_PLAN_CONTRACT: &str = "arda.hades.organization_plan.v1";
const ORGANIZATION_CANDIDATE_CONTRACT: &str = "arda.hades.organization_candidate.v1";
const ORGANIZATION_APPROVAL_PACKET_CONTRACT: &str =
    "arda.hades.organization_operator_approval_packet.v1";
const ORGANIZATION_APPLY_RECEIPT_CONTRACT: &str = "arda.hades.organization_apply_receipt.v1";
...
fn parse_candidate_array(packet: &Value) -> Result<Vec<OrganizationCandidate>> {
    ...
    serde_json::from_value(candidates).map_err(ArdaError::from)
}
