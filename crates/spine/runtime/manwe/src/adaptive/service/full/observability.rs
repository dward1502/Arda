...
fn free_provider_pool_rollup(providers: &[crate::adaptive::types::ProviderState]) -> JsonValue {
    ...
    let mut rows = providers
        ...
        .map(|provider| {
            ...
            let profile = derive_route_execution_profile(
                &crate::adaptive::types::ManweRequestEnvelope {
...
fn provider_is_free_pool_member(
    provider: &crate::adaptive::types::ProviderState,
...
fn model_is_free(model: &crate::adaptive::types::ModelState) -> bool {
