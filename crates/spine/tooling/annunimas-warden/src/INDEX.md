...
# Index: crates/tooling/annunimas-warden/src/INDEX.md
...
- `monitor.rs`
- `podman.rs`
- `runaway_loop_detector`
- `schema_drift_detector`
- `scoring.rs`

## Purpose

Crate index for `crates/tooling/annunimas-warden/src/INDEX.md`. See sibling `INDEX.md` for bucket metadata.
