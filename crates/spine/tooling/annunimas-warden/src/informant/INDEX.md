...
# Index: crates/tooling/annunimas-warden/src/informant/INDEX.md
...
Crate index for `crates/tooling/annunimas-warden/src/informant/INDEX.md`. See sibling `INDEX.md` for bucket metadata.
