...
# Index: crates/tooling/arda-forge-mind/src/tools/INDEX.md
...
Crate index for `crates/tooling/arda-forge-mind/src/tools/INDEX.md`. See sibling `INDEX.md` for bucket metadata.
