...
# Index: crates/tooling/arda-forge-mind/tests/INDEX.md
...
Crate index for `crates/tooling/arda-forge-mind/tests/INDEX.md`. See sibling `INDEX.md` for bucket metadata.
