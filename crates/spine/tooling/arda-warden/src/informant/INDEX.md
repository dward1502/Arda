...
# Index: crates/tooling/arda-warden/src/informant/INDEX.md
...
Crate index for `crates/tooling/arda-warden/src/informant/INDEX.md`. See sibling `INDEX.md` for bucket metadata.
