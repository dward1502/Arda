...
| Leave one live authority per domain | **implementation pass / native proof open** | Monitor sessions, both system-health domains, Workbench, Research, and Personal Operations now have installed Rust authority. Final native configured-identity/envelope walkthroughs and five-monitor acceptance remain evidence gates rather than parallel implementation authorities. |
