...
| [HUD Universal Agent Monitor Surfaces](../archive/2026-08-03-arda-hud-universal-agent-monitor-surfaces-plan.md) | **completed corrective surface** | Historical authority for the five independent native monitor sessions, typed content, workstation continuity, lifecycle isolation, blocked-frame capture, and restart recovery accepted on 2026-08-12. | Live source and tests now own behavior; no monitor acceptance checks remain open. |
