# EMBODIED_INTERFACE Plan Narrative
...
EMBODIED_INTERFACE covers the Pi5 / Pepper's Ghost path, CITADEL Companion, RELIC visualization, runtime-truth-bound visual doctrine, and future gated voice/physical interaction boundaries. The current quick reference is `docs/plans/EMBODIED_INTERFACE.md`.

## Core Runtime Surfaces

The reviewed contract is represented by these primary surfaces:

- `docs/plans/EMBODIED_INTERFACE.md` — quick reference and operator-facing plan narrative
