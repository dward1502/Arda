...
- `core/projects/Plans/OPENFANG.md` exists and points to `docs/plans/OPENFANG.md`, `core/state/openfang_alignment.json`, and ATHENA source evidence.
...
test -f core/projects/Plans/OPENFANG.md
...
## References
- Core quick reference: `core/projects/Plans/OPENFANG.md`
