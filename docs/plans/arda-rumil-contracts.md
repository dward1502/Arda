...
**Status:** Design baseline for `2026-08-03-arda-rumil-project-audit-plan.md`  
**Contract namespace:** `arda.rumil.*`

This file defines the first packet shapes before implementation. It is intentionally an outline, not a Rust schema claim. Exact field types and compatibility tests belong in the future `arda-rumil` crate and, where cross-process transport is required, `outposts/arda-outpost-protocol`.
